...
A proposta deste artigo é a criação de um modelo que consiga entender o
...
Após, prosseguiu-se com o treinamento do modelo. Utilizou-se com base de
treinamento o período compreendido entre 01/01/2018 e 31/07/2018. 
Normalizou-se as variáveis para todas ficarem compreendidas no intervalo entre 
zero e um. 

Estruturou-se a rede neural com a seguinte configuração:
